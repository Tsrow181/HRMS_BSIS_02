                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>04:00 PM</td>
                                                <td>8 hours</td>
                                                <td><span class="attendance-status badge badge-success">Present</span></td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>-</td>
                                                <td>0 hours</td>
                                                <td><span class="attendance-status badge badge-danger">Absent</span></td>
                                                <td>
                                                    <button class="btn btn-sm btn-outline-primary mr-2">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress mb-2">
                                    <div class="progress-bar bg-success" style="width: 67%">Present (67%)</div>
                                </div>
                                <div class="progress">
                                    <div class="progress-bar bg-danger" style="width: 33%">Absent (33%)</div>
                                </div>
                            </div>
                        </div>
                    </div>
